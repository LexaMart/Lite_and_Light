    ...
    <div className="fabros">
      ...
      <div className="fabros-flex-box">
        <div className="fabros-flex-box-item">
          <img alt="img" src={fabros2} className="fabros-flex-box-item-img" />
          <img alt="img" src={fabros4} className="fabros-flex-box-item-img" />
        </div>
        <div className="fabros-flex-box-item">
          <img alt="img" src={fabros3} className="fabros-flex-box-item-img" />
          <img alt="img" src={fabros5} className="fabros-flex-box-item-img" />
        </div>
      </div>
    </div>
  );
